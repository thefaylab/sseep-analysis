...
## LOAD DATA ####
fall_sys_data <- readRDS(here("data", "sumflounder", "sf_fall-system_rm-fullset.rds"))
...
### save data 
saveRDS(slopes, here("data", "sumflounder", "systematic-preclusion", "sf_fall-system_rm-slopes.rds"))
...
### save plot
ggsave("fall_sys-precl_plot.png", plot = last_plot(), device = "png", path = here("outputs", "sumflounder"), width = 7, height = 4)
