...
## LOAD DATA ####
spr_sys_data <- readRDS(here("data", "sumflounder", "sf_fall-system_rm-fullset.rds"))
...
### save plot
ggsave("spr_sys-precl_plot.png", plot = last_plot(), device = "png", path = here("outputs", "sumflounder"), width = 7, height = 4)
