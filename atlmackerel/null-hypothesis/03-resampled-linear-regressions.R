...
### LOAD DATA ####
# "No preclusion" dataset containing 1000 replicates of summer flounder data resampled for 100% of the historical observations created here("atlmackerel", "01-data-resample.R")
fullreps_mu <- readRDS(here(null.hyp.data, "full_resamp_stratmu.rds"))

# "Preclusion" dataset containing 1000 replicates of summer flounder data resampled for 90% of the historical observations created here("atlmackerel", "01-data-resample.R")
