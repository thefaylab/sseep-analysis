...
```{r}
bind_rows(base1_diff, base10_diff, base100_diff, enhanced1_diff, enhanced10_diff, enhanced100_diff, reduced1_diff, reduced10_diff, reduced100_diff) |>
  ggplot() +
  geom_boxplot(aes(x = as.factor(type), y = abs_diff, color = mean)) + 
