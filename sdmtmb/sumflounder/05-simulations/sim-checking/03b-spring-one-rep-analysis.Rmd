...
ggplot(all_stratmu) +
  ...
  labs(x = "Wind-driven productivity scenario", y = "Stratified Mean (kg/tow)", title = "Spring productivity scenarios for summer flounder", subtitle = "Changes in the 2019 abundance index for summer flounder in response to changes in productivity inside wind energy areas") +
  ylim(0,NA) +
  theme_bw() + 
