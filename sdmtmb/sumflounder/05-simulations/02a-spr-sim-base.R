...
# save the data 
saveRDS(spr.base_sims, here("sdmtmb", "sumflounder", "data", "simulations", "spring_base_sim.rds"))
...
# save the data 
saveRDS(full_stratmu, here("sdmtmb", "sumflounder", "data", "simulations", "spring_base_all-stratmu.rds"))
