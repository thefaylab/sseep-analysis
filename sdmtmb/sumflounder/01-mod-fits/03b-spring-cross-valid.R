...
#### M8 ####
# 
m8spr.cv <- sdmTMB_cv(EXPCATCHWT ~ s(AVGDEPTH) + as.factor(EST_YEAR)+ as.factor(AREA),#-1,
                    data = sf_spring,
                    mesh = spring_mesh,
                    family = tweedie(link = "log"), 
                    spatial = "on", 
...
#### M9 ####
# 
m9spr.cv <- sdmTMB_cv(EXPCATCHWT ~ AVGDEPTH,
                    data = sf_spring,
                    mesh = spring_mesh,
                    family = tweedie(link = "log"), 
                    spatial = "on", 
...
#### M10 ####
# 
m10spr.cv<- sdmTMB_cv(EXPCATCHWT ~ s(AVGDEPTH) + as.factor(EST_YEAR)-1,
                     data = sf_spring,
                     mesh = spring_mesh,
                     family = tweedie(link = "log"), 
                     spatial = "on", 
...
m11spr.cv <- sdmTMB_cv(EXPCATCHWT ~ s(AVGDEPTH) + as.factor(EST_YEAR)+ as.factor(AREA),
                     data = sf_spring,
                     mesh = spring_mesh,
                     family = tweedie(link = "log"), 
                     spatial = "on", 
...
#### M12 ####
# 
m12spr.cv <- sdmTMB_cv(EXPCATCHWT ~ AVGDEPTH,
                     data = sf_spring,
                     mesh = spring_mesh,
                     family = tweedie(link = "log"), 
                     spatial = "on", 
