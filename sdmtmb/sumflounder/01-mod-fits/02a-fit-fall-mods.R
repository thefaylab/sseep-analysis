...
# 
# ### save the data
# saveRDS(m15_fall, file = here("sdmtmb", "sumflounder", "data", "mods", "m15_fall.rds"))
...
# 
# ### save the data
# saveRDS(m16_fall, file = here("sdmtmb", "sumflounder", "data", "mods", "m16_fall.rds"))
...
# 
# # save the data 
# saveRDS(m17_fall, file = here("sdmtmb", "sumflounder", "data", "mods", "m17_fall.rds"))
...
# 
# # save the data 
# saveRDS(m18_fall, file = here("sdmtmb", "sumflounder", "data", "mods", "m18_fall.rds"))
...
# 
# # save the data 
# saveRDS(m19_fall, file = here("sdmtmb", "sumflounder", "data", "mods", "m19_fall.rds"))
...
# 
# # save the data 
# saveRDS(m20_fall, file = here("sdmtmb", "sumflounder", "data", "mods", "m20_fall.rds"))
