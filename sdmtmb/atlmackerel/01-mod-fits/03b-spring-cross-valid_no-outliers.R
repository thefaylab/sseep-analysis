...
tweedie.cvs <- here("sdmtmb", "atlmackerel", "data", "cross-valid", "tweedie", "no-bio-out")
dpg.cvs <- here("sdmtmb", "atlmackerel", "data", "cross-valid", "dpg", "no-bio-out")

### DATA ####
atlmack <-  readRDS(here(atlmack.dat, "atlmackerel_spring_no-outliers.rds")) |> 
