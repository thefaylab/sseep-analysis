...
# saveRDS(clust, here("sdmtmb", "atlmackerel", "data", "cross-valid", "atlmack-clust.rds"))
...
#### M1 ####
# m1.1.cv.dpg <- sdmTMB_cv(EXPCATCHWT ~ s(AVGDEPTH) + EST_YEAR - 1,
#                         data = atlmack,
#                         mesh = spring_mesh,
...
# 
# # save the data
# saveRDS(m1.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m1-cv-dpg.rds"))
# 
# #### M2 ####
...
# 
# # save the data
# saveRDS(m2.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m2-cv-dpg.rds"))
# 
# #### M3 ####
...
# 
# # save the data
# saveRDS(m3.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m3-cv-dpg.rds"))
# 
# #### M4 ####
...
# 
# # save the data
# saveRDS(m4.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m4-cv-dpg.rds"))
# 
# ### Spatial Only Models ####
# #### M5 ####
...
# m5.1.cv.dpg <- sdmTMB_cv(EXPCATCHWT ~ s(AVGDEPTH) + EST_YEAR - 1,
#                         data = atlmack,
#                         mesh = spring_mesh,
...
# 
# # save the data
# saveRDS(m5.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m5-cv-dpg.rds"))
# 
# #### M6 ####
...
# 
# # save the data
# saveRDS(m6.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m6-cv-dpg.rds"))
# 
# #### M7 ####
...
# 
# # save the data
# saveRDS(m7.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m7-cv-dpg.rds"))
# 
# #### M8 ####
...
# 
# # save the data
# saveRDS(m8.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m8-cv-dpg.rds"))
# 
# 
# ### Spatiotemporal Models - IID Structure ####
# 
...
# m9.1.cv.dpg <- sdmTMB_cv(EXPCATCHWT ~ s(AVGDEPTH) + EST_YEAR - 1,
#                         data = atlmack,
#                         mesh = spring_mesh,
#                         family = delta_poisson_link_gamma(),
#                         spatial = "on",
...
# 
# ### save the data
# saveRDS(m9.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m9-cv-dpg.rds"))
# 
# #### M10 ####
# #logistic regression of summer flounder biomass in tows as a function of AVGDEPTH with spatial random effects and spatiotemporal random fields estimated by EST_YEAR and with a separate intercept for each.
...
# 
# ### save the data
# saveRDS(m10.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m10-cv-dpg.rds"))
# 
# 
# #### M11 ####
...
# 
# ### save the data
# saveRDS(m11.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m11-cv-dpg.rds"))
# 
# #### M12 ####
# #  logistic regression of summer flounder biomass catch rate as a function of depth, year, and inside or outside wind area. 
...
# 
# ### save the data
# saveRDS(m12.cv.dpg, file = here("sdmtmb", "atlmackerel", "data", "cross-valid", "m12-cv-dpg.rds"))
