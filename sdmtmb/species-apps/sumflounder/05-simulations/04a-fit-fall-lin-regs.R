...
base_stratmu <- readRDS(here("sdmtmb", "sumflounder", "data", "simulations", "0828-fall", "FallSimFuture_BaseStratmu.rds"))

inc_stratmu <- readRDS(here("sdmtmb", "sumflounder", "data", "simulations", "0828-fall", "FallSimFuture_IncreaseStratmu.rds"))

dec_stratmu <- readRDS(here("sdmtmb", "sumflounder", "data", "simulations", "0828-fall", "FallSimFuture_DecreaseStratmu.rds"))

obs_stratmu <- readRDS(here("data", "sumflounder", "sf_stratmu.rds")) |> filter(EST_YEAR %in% c(2016:2021), SEASON == "FALL")

### DATA WRANGLE ####
obs_stratmu <- map_dfr(seq(1:25), ~obs_stratmu |>mutate(rep = .x))
...
saveRDS(base_incl.lm, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_BaseIncludedLMs.rds"))
...
saveRDS(base_incl.slopes, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_BaseIncludedSlopes.rds"))
...
saveRDS(base_precl.lm, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_BasePrecludedLMs.rds"))
...
saveRDS(base_precl.slopes, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_BasePrecludedSlopes.rds"))
...
saveRDS(inc_incl.lm, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_IncreaseIncludedLMs.rds"))
...
saveRDS(inc_incl.slopes, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_IncreaseIncludedSlopes.rds"))
...
saveRDS(inc_precl.lm, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_IncreasePrecludedLMs.rds"))
...
saveRDS(inc_precl.slopes, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_IncreasePrecludedSlopes.rds"))
...
saveRDS(dec_incl.lm, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_DecreaseIncludedLMs.rds"))
...
saveRDS(dec_incl.slopes, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_DecreaseIncludedSlopes.rds"))
...
saveRDS(dec_precl.lm, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_DecreasePrecludedLMs.rds"))
...
saveRDS(dec_precl.slopes, here("sdmtmb", "sumflounder", "data", "simulations", "FallSimFuture_DecreasePrecludedSlopes.rds"))
