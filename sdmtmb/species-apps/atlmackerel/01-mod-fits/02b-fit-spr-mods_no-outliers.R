...
# 02b - FIT SPRING MODELS: NO BIOMASS OUTLIERS ####
...
tweedie.mods <- here("sdmtmb", "atlmackerel", "data", "mods", "tweedie", "no-bio-out")
dpg.mods <- here("sdmtmb", "atlmackerel", "data", "mods", "dpg", "no-bio-out")

### LOAD DATA ####
# Atlantic mackerel data created in `01-prepare-data.R` 
am_spring <- readRDS(here(atlmack.dat, "atlmackerel_spring_no-outliers.rds")) |> 
