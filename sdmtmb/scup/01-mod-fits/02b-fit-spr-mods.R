...
# save the data
saveRDS(m1_spring, file = here("sdmtmb", "scup", "data", "mods", "m1_spring.rds"))
...
# save the data
saveRDS(m2_spring, file = here("sdmtmb", "scup", "data", "mods", "m2_spring.rds"))
...
# save the data
saveRDS(m3_spring, file = here("sdmtmb", "scup", "data", "mods", "m3_spring.rds"))
...
# save the data
saveRDS(m4_spring, file = here("sdmtmb", "scup", "data", "mods", "m4_spring.rds"))
...
# save the data
saveRDS(m5_spring, file = here("sdmtmb", "scup", "data", "mods", "m5_spring.rds"))
...
# save the data
saveRDS(m6_spring, file = here("sdmtmb", "scup", "data", "mods", "m6_spring.rds"))
...
# save the data
saveRDS(m7_spring, file = here("sdmtmb", "scup", "data", "mods", "m7_spring.rds"))
...
# save the data
saveRDS(m8_spring, file = here("sdmtmb", "scup", "data", "mods", "m8_spring.rds"))
...
### save the data
saveRDS(m9_spring, file = here("sdmtmb", "scup", "data", "mods", "m9_spring.rds"))
...
### save the data
saveRDS(m10_spring, file = here("sdmtmb", "scup", "data", "mods", "m10_spring.rds"))
...
### save the data
saveRDS(m11_spring, file = here("sdmtmb", "scup", "data", "mods", "m11_spring.rds"))
...
### save the data
saveRDS(m12_spring, file = here("sdmtmb", "scup", "data", "mods", "m12_spring.rds"))
