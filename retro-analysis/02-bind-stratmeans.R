...
nowind_strat <- readRDS(here("data", "rds", "retro-analysis", "strat-mu_included.rds")) 

# dataset where tows occurring in wind areas were removed from mean and variance calculations
wind_strat <- readRDS(here("data", "rds", "retro-analysis", "strat-mu_preclusion.rds"))
...
#### BIND DATASETS ####
saveRDS(stratmeans, here("data", "rds",  "retro-analysis", "strat-mu_all.rds"))
